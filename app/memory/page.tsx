...
const CHARACTERS = [
  { pair: 'taekwondo', image: '/memory/full-taekwondo-v3.png' },
  { pair: 'overalls', image: '/memory/full-overalls-v3.png' },
  { pair: 'chef', image: '/memory/full-chef-v3.png' },
  { pair: 'magic', image: '/memory/full-magic-v3.png' },
  { pair: 'pajamas', image: '/memory/full-pajamas-v3.png' },
  { pair: 'dinosaur', image: '/memory/full-dinosaur-v3.png' },
] as const;

const JOURNEY_DESTINATIONS = [
  { label: '从头体验一次', href: '/' },
  { label: '书店', href: '/?scene=bookstore' },
  { label: '服装店', href: '/?scene=outfit' },
  { label: '舞台', href: '/?scene=stage' },
  { label: '露营地', href: '/?scene=camp' },
  { label: '呆小咖的小屋', href: '/?scene=home' },
] as const;
              ...
              >
                <span className="memory-card-inner">
                  <span className="memory-card-face memory-card-back" aria-hidden="true">
                    <img src="/memory/card-back.png" alt="" draggable={false} />
                  </span>
